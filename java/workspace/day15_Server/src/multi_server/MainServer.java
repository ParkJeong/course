...
public class MainServer {
	// 서버에 접속하는 클라이언트들의 OutputStream이 담긴 PrintWriter를 저장
	public static ArrayList<PrintWriter> pws = new ArrayList<>();
	...
	public static void main(String[] args) {
		 ...
		 * 클라리언트에게 받은 데이터를 모든 클라이언트에게 전달하도록 처리한다.
		 * 
		 */
		try {
			...
			int count = 0;
			while(true) {
				System.out.println("------연결 대기 " + count++ + "-----");
